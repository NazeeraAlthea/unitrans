...
<head>
    <meta charset="UTF-8">
    <title>TransQuest - Find Your Perfect Transportation</title>
...
<body class="bg-white min-h-screen flex items-center">
    ...
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-8 py-16 w-4/5">
        ...
        <div class="w-full md:w-1/2 space-y-6">
            ...
            <p class="text-gray-500 text-lg mr-10 text-justify">Pilih transportasi ke kampus dengan lebih mudah dan sesuai kebutuhanmu.</p>
            <a href="{{ route('spk.form') }}"
               class="inline-flex items-center bg-blue-600 text-white px-6 py-3 rounded-lg shadow hover:bg-blue-700 transition font-semibold text-lg">
                ...
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.25"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-bus"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M18 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M4 17h-2v-11a1 1 0 0 1 1 -1h14a5 7 0 0 1 5 7v5h-2m-4 0h-8" /><path d="M16 5l1.5 7l4.5 0" /><path d="M2 10l15 0" /><path d="M7 5l0 5" /><path d="M12 5l0 5" /></svg>
            </a>
            <!-- Info Keterangan -->
            <div class="flex items-start mt-8">
                ...
                <p class="ml-3 mr-10 text-gray-600 text-base text-justify">
                    Pilih transportasi ke kampus dengan lebih mudah dan tepat. Sistem ini membantumu membandingkan berbagai pilihan transportasi dengan akurat.
                </p>
            </div>
        </div>
        <!-- Kanan: Gambar -->
